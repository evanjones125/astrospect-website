...
declare module 'astro:assets' {
	...
	type AstroAssets = {
		getImage: typeof import('astro/dist/assets/index.js').getImage;
		Image: typeof import('astro/components/Image.astro.js').default;
	};

	type WithRequired<T, K extends keyof T> = T & { [P in K]-?: T[P] };
	type Simplify<T> = { [KeyType in keyof T]: T[KeyType] };
	type ImgAttributes = WithRequired<
		Omit<import('astro/types.js').HTMLAttributes<'img'>, 'src' | 'width' | 'height'>,
		'alt'
	>;

	export type LocalImageProps = Simplify<
		import('astro/dist/assets/types.js').LocalImageProps<ImgAttributes>
	>;
	export type RemoteImageProps = Simplify<
		import('astro/dist/assets/types.js').RemoteImageProps<ImgAttributes>
	>;
...
declare module 'astro:ssr-manifest' {
	export const manifest: import('astro').SSRManifest;
}
