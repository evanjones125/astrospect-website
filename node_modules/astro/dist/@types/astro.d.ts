...
import type { PageBuildData } from 'astro/dist/core/build/types';
import type { AstroConfigSchema } from 'astro/dist/core/config';
import type { AstroTimer } from 'astro/dist/core/config/timer';
import type { AstroCookies } from 'astro/dist/core/cookies';
import type { LogOptions } from 'astro/dist/core/logger/core';
import type { AstroComponentFactory, AstroComponentInstance } from 'astro/dist/runtime/server';
...
export type { ExternalImageService, LocalImageService } from 'astro/dist/assets/services/service';
export type { ImageTransform } from 'astro/dist/assets/types';
export type { SSRManifest } from 'astro/app/types';
export type { AstroCookies } from 'astro/dist/core/cookies';
